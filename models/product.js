...
const ProductPipeline = [
                ...
                $map: {
                    ...
                    in: {
                        $mergeObjects: ['$$color', {
                            ...
                            description_short: {$ifNull: ["$$color.description_short","$description_short"]},
                            price: {$ifNull: ["$$color.price","$price"]},
                            slug: {$ifNull: ["$$color.slug", {$concat: ["$slug", "-", "$$color.color"]}]},
                        }]
                    }
                }
            }
    ...
    {$project: {
            ...
            meta_title: {$ifNull: ["$color.meta_title", {$concat: ["$meta_title"," ","$color.color"]}]},
            meta_description: {$ifNull: ["$color.meta_description", {$concat: ["$meta_description", " ", "$color.color"]}]},
            slug: {$ifNull: ["$color.slug", {$concat: ["$slug", "-", "$color.color"]}]},
